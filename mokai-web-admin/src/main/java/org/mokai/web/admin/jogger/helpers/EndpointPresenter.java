...
/**
 * DTO used to pass endpoints to the view.
 *
 * @author German Escobar
 */
public class EndpointPresenter {
    ...
    public EndpointPresenter() {
    }

    public EndpointPresenter(ConnectorService connectorService) {
        this.id = connectorService.getId();
        this.type = WebUtil.getComponentName(connectorService.getConnector()).replaceAll("\\s+", "_");
    ...
    public EndpointPresenter withId(String id) {
        setId(id);
        return this;
    }
    ...
    public EndpointPresenter withType(String type) {
        setType(type);
        return this;
    }
    ...
    public EndpointPresenter withState(String state) {
        setState(state);
        return this;
    }
    ...
    public EndpointPresenter withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public EndpointPresenter withQueuedMessages(int queuedMessages) {
    ...
    public EndpointPresenter withProcessor(boolean processor) {
