...
public class ConnectorPresenter {
	...
	public ConnectorPresenter(ConnectorService connectorService) {
	...
	public ConnectorPresenter withId(String id) {
		setId(id);
		return this;
	}
	...
	public ConnectorPresenter withType(String type) {
		setType(type);
		return this;
	}
	...
	public ConnectorPresenter withState(String state) {
		setState(state);
		return this;
	}
	...
	public ConnectorPresenter withStatus(String status) {
		setStatus(status);
		return this;
	}
	...
	public ConnectorPresenter withQueuedMessages(int queuedMessages) {
	...
	public ConnectorPresenter withProcessor(boolean processor) {
