...
public enum TableScripts {
	 ...
	 */
	DERBY_CONNECTIONS(ConnectionsSmsHandler.DEFAULT_TABLENAME, 
			"CREATE TABLE " + ConnectionsSmsHandler.DEFAULT_TABLENAME + " (" +
	 ...
	 */
	MYSQL_CONNECTIONS(ConnectionsSmsHandler.DEFAULT_TABLENAME, 
			"CREATE TABLE " + ConnectionsSmsHandler.DEFAULT_TABLENAME + " (" +
	...
	/**
	 * Derby script to create a table for application sms messages.
	 */
	DERBY_APPLICATIONS(ApplicationsSmsHandler.DEFAULT_TABLENAME, 
			"CREATE TABLE " + ApplicationsSmsHandler.DEFAULT_TABLENAME + " (" +
			"id BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), " +
			"account VARCHAR(30), " +
			"reference VARCHAR(100), " +
			"source VARCHAR(30) NOT NULL, " +
	...
	/**
	 * MySql script to create an table for applications sms messages.
	 */
	MYSQL_APPLICATIONS(ApplicationsSmsHandler.DEFAULT_TABLENAME, 
			"CREATE TABLE " + ApplicationsSmsHandler.DEFAULT_TABLENAME + " (" +
			"id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, " +
			"account VARCHAR(30), " +
			"reference VARCHAR(100), " +
